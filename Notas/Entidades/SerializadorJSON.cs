...
namespace Entidades
{
    public static class SerializadorJSON<T>  where T : class
    {
        ...
        static SerializadorJSON()
        {
            ...
            SerializadorJSON<T>.rutaDirectorioBase = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Notas/");
        }
        ...
        private static string ObtenerRutaCompletaArchivo(string rutaRelativa)
        {
            ...
            throw new ArgumentNullException("Ruta NULL");
        }
        ...
        public static bool Guardar(string rutaRelativaArchivo, T elemento)
        {
            ...
            try
            {
                ...
                throw new ArgumentNullException("El elemento a serializar es NULL");
            }
            catch (Exception ex)
            {
